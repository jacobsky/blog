...
and that it's not great for adding reactivity to MPAs.
...
The first simplest trick is to simply use a bunch of different sub routes,
such as by using specific wildcards.
...
Datastar automatically sends the `Datastar-Request: true` header with every
